...
namespace Engine.Image.Control
{
    ...
    public partial class MapContainer : UserControl
    {
        ...
        //#region  事件支持 地图缩放
        //void filter_OnQueryFilterEvent(int zoomindex, System.Drawing.Point screenPoint)
        //{
        ...
        //        m_graphic.DrawImage(m_buffer,new System.Drawing.Point(e.X,e.Y));
        ...
        //        context_tree_view.Show(tree_view, new System.Drawing.Point(e.X, e.Y));
        //    }
        //}
        ////获取bitmap2委托
