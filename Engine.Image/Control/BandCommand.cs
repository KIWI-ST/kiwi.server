...
namespace Engine.Image.Control
{
    public partial class BandCommand : UserControl
    {
        ...
        {
            //listView1.Bounds = new Rectangle(new  System.Drawing.Point(10, 10), new Size(300, 200));
            ...
            //    //bitmap
            //    imageList.Images.Add(Analysis.BitmapAndByte.ToGrayBitmap(_dataClassContainer[count].Data, _dataClassContainer[count].Data.GetLength(0), _dataClassContainer[count].Data.GetLength(1)));
            //}
        ...
        {
            return null;
            //return Analysis.BitmapAndByte.ToRgbBitmap(_dataClassContainer[_bandIndexSave[0]].Data, _dataClassContainer[_bandIndexSave[1]].Data, _dataClassContainer[_bandIndexSave[2]].Data);
        }
    }
}
