...
namespace Engine.NLP.Forms
{
    ...
    public partial class NLPExpertiseForm : Form
    {
        ...
        void InitialConfigValue()
        {
            ...
            hazard = NLPConfiguration.HazardString.Split(';').ToList();
            exposure = NLPConfiguration.ExposureString.Split(';').ToList();
            humanBehavior = NLPConfiguration.HumanBehaviorString.Split(';').ToList();
            //ui
